/*Crie um programa que vai receber do usuário o valor do produto e a 
 * quantidade do produto que se deseja. Com essas informações encontre 
 * o subtotal que será o valor do produto multiplicado pela quantidade.
 * Depois você vai precisar usar uma estrutura de decisão. Se a 
 * quantidade desejada do produto for maior que 10 unidades, vai ser 
 * preciso dar um desconto de 10% em cima do subtotal, mas se for menor 
 * que 10, você NÃO aplica desconto algum.
 * Para encontrar o valor referente ao percentual de desconto 
 * (que vai ser 0% ou 10%, dependendo da quantidade) você multiplica 
...
public class ImprimirValorTotalDesconto {
